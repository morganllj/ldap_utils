...
### THIS VERSION OF THE SCRIPT WILL PRINT OUT THE ACTIONS, BUT NO USER WILL BE DELETED. THIS IS FOR TESTING PURPOSES.
...
def expireGoogleAccount(a,b):
    ...
    if(results["externalIds"][0]["value"]==eidn):
        print("EIDNs Match! If this were the live scipt, the following user account would be deleted: ", user, ".")
        return 0
